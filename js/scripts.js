...
$('#exampleModal').on('show.bs.modal', function (event) {
    /*
    # Modal Modify
         The following function sets out to change the contents of the default modal. It uses jquery to find each item,
         then goes through the dictionary to find relevant information.
    */
    ...
    if (project['images'].length > 0) {
        ...
        modal.find('.modal-body .col-5').prepend('<div class="card-background"><model-viewer class="card-img-top" src="'+ project['model'] + '" alt="' + project['title'] + '" auto-rotate camera-controls interaction-prompt="none"></model-viewer></div>')
    }
...
$("#exampleModal").on("hidden.bs.modal", function() {
    /*
    Modal Reset
        The following function resets the contents of the modal window when it is hidden to get ready for the next open.
        */
    $(".modal-dialog").html('<div class="modal-content">\n' +
        ...
        '                    <div class="row">\n' +
        '                        <div class="col-5">\n' +
        '                            <div id="modalCarousel" class="carousel slide carousel-fade d-none" data-ride="carousel">\n' +
